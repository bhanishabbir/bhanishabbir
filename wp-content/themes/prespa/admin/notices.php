...
class prespa_notice {
	...
	public function hide_notices() {
		...
		if ( isset( $_GET['prespa-hide-notice'] ) && isset( $_GET['_prespa_notice_nonce'] ) ) {
			...
			if ( $_GET['prespa-hide-notice'] ) {
				
				$hide_notice_id = sanitize_text_field( wp_unslash( $_GET['prespa-hide-notice'] ) );
